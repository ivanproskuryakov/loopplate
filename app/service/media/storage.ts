...
import {StorageConfigInterface} from 'app/service/media/storageConfigInterface';
import {RemoteFileInterface} from 'app/service/media/remoteFileInterface';

/**
 * class to handle all storage stuff
 * @class Storage
...
export class Storage {
   ...
   * @returns {Promise<RemoteFileInterface>}
   */
  public upload(file: Express.Multer.File, filename?: string): Promise<RemoteFileInterface> {
