declare module 'loopback-crud' {
  namespace db {
    ...
    export interface DataAccessObject<T> {
      ...
      upsertWithWhere(where: Where, data: T, options?: Options, callback?: Callback<T|T[]>): any;
      ...
      update(where?: Where, data?: T|Object, options?: Options, callback?: Callback<T>): any;
      updateAll(where?: Where, data?: T|Object, options?: Options, callback?: Callback<T>): any;
    ...
    export interface DataObject<T> {
       ...
       * @param callback
       */
      updateAttribute(property: string, value: any, callback?: Callback<T>): any;
    ...
    /**
     * @see https://docs.strongloop.com/display/public/LB/Embedded+models+and+relations#Embeddedmodelsandrelations-ReferencesMany
     */
    export interface ReferencesManyRelation<T> {
       ...
       * @param {string} fk
       */
      exists: (fk: string, cb?: () => void) => Promise<boolean>;

      /**
       *
       * @param {string} id
       */
      add: (id: string, cb?: () => void) => Promise<any>;

      /**
       *
       * @param {string} id
       */
      remove: (id: string, cb?: () => void) => Promise<any>;
